...
define(["util", "scene"], 
     ...
     *
     */
    SceneController.prototype.onSelection = function(showRadius) {
    ...
    SceneController.prototype.select = function(obj) {
        ...
        // show object info in parameter area
        $(document).ready( (function() {
        	if (obj.radius) {
	    		$("#radiusDiv").show();
	           	$("#infoRadius").val(obj.radius);
	    	}
	    	else {
	    		$("#radiusDiv").hide();
	    	}
           	$("#infoLine").val(obj.lineStyle.width);
           	$("#infoColor").val(obj.lineStyle.color);
        }));
    };
